...
const products = [
  ...
  {
    name: "Majun Warna",
    desc: "Kain majun berbagai warna untuk berbagai kebutuhan. Tahan lama, absorbensi optimal, harga ekonomis.",
      ...
      <header className="sticky top-0 z-50 w-full border-b border-zinc-200 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/80">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-6 md:flex">
            ...
            <Button onClick={handleEnterAdmin} size="sm" className="gap-2" disabled={loading}>
              {loading ? "..." : <><ArrowRight className="h-4 w-4" /> Masuk Admin</>}
            </Button>
          </nav>
          ...
          <div className="border-t border-zinc-200 md:hidden bg-white">
            <nav className="flex flex-col gap-1 p-4">
              ...
              <div className="mt-2 border-t border-zinc-200 pt-3">
                <Button onClick={handleEnterAdmin} size="sm" className="w-full gap-2" disabled={loading}>
                  {loading ? "..." : <><ArrowRight className="h-4 w-4" /> Masuk Admin</>}
                </Button>
              </div>
            </nav>
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 lg:items-center">
              ...
              <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer">
                <Phone className="h-4 w-4" /> Chat WhatsApp
                  ...
                  <Button onClick={handleEnterAdmin} size="lg" variant="outline" className="gap-2" disabled={loading}>
                    {loading ? "..." : <><ArrowRight className="h-4 w-4" /> Masuk Sistem</>}
                  </Button>
                </div>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
              <div>
                ...
                <p className="mt-4 text-base leading-7 text-zinc-400">
                  CV. SIDARMA MAJUN hadir sebagai solusi supplier kain majun berkualitas dengan harga langsung dari sumber. Dengan pengalaman lebih dari 5 tahun, kami melayani ratusan toko dan pabrik di Pulau Jawa.
                </p>
        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl rounded-2xl border border-zinc-200 bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 px-6 py-12 text-center shadow-xl sm:px-10 sm:py-14">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              ...
              <Button onClick={handleEnterAdmin} size="lg" variant="outline" className="gap-2 border-zinc-700 bg-transparent text-white hover:bg-zinc-800 hover:text-white" disabled={loading}>
                {loading ? "..." : <><ArrowRight className="h-4 w-4" /> Masuk Sistem Admin</>}
              </Button>
            </div>
          </div>
        </section>
